  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-white to-slate-100 dark:from-zinc-950 dark:to-zinc-900 px-4 py-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 z-10 relative">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
            About Me
          </h2>

          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            I’m <strong>Reazul Alavhi</strong> — or you can call me <strong>Riyan</strong>. A full-stack developer from Bangladesh, I love crafting engaging, scalable web apps using <strong>Next.js</strong>, <strong>React</strong>, <strong>Node.js</strong>, and <strong>MongoDB</strong>.
          </p>

          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            I’m also an entrepreneur at heart — currently planning to launch a hybrid business in <strong>Cape Town or Durban</strong> selling everything from tech to chocolates. My mission is to merge digital innovation with real-world impact.
          </p>
